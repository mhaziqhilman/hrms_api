...
const emailConfigurationRoutes = require('./routes/emailConfiguration.routes');
...
const authLimiter = rateLimit({
  ...
  standardHeaders: true,
  legacyHeaders: false,
  skip: () => process.env.DISABLE_AUTH_RATE_LIMIT === 'true' || (process.env.NODE_ENV === 'development' && process.env.RATE_LIMIT_ENABLED !== 'true')
});
...
app.use('/api/email-config', emailConfigurationRoutes);
