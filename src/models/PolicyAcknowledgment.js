...
const PolicyAcknowledgment = sequelize.define('PolicyAcknowledgment', {
  ...
  viewed_at: {
    ...
    field: 'viewed_at',
    _comment: 'Timestamp when employee first viewed the policy'
  },
  acknowledged_at: {
    type: DataTypes.DATE,
    allowNull: true,
    field: 'acknowledged_at',
    _comment: 'Timestamp when employee acknowledged understanding'
  },
  policy_version: {
    type: DataTypes.STRING(20),
    allowNull: false,
    field: 'policy_version',
    _comment: 'Version of policy that was acknowledged'
  },
  ip_address: {
  ...
  comments: {
    type: DataTypes.TEXT,
    allowNull: true,
    _comment: 'Optional comments from employee'
  }
}, {
